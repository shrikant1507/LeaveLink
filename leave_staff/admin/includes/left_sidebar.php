<div class="left-side-bar">
		<div class="brand-logo">
			<a href="admin_dashboard.php">
				<img src="C:\xampp\htdocs\leave_staff\ll.jpg" alt="" class="dark-logo">
				<img src="C:\xampp\htdocs\leave_staff\ll.jpg" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="https://google.com" class="dropdown-toggle no-arrow" target="_blank">
